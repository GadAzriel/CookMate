      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden w-full max-w-screen-xl p-8">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center relative mb-4">
            <Link to="/" className="bg-gray-500 text-white text-center py-2 px-6 rounded-full hover:bg-gray-700 transition duration-300 absolute left-0">
              Back
            </Link>
            <h1 className="text-4xl md:text-5xl font-bold text-center w-full">
              CookMate's Recipes
            </h1>
            <div className="hidden md:block absolute right-0 w-24"></div> {/* Placeholder for balance */}
          </div>
